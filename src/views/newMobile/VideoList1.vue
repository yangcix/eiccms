<template>
	<div class="video-wrap">
        ...
        <div v-if="val.isHabitus == 1">
          <p class="video-status" v-if="val.playStatus == 0">
            <i class="iconfont icon-livebroadcast"></i>
            <span>授课中</span>
          </p>
          <p class="video-status" v-if="val.playStatus == 1 || (val.playStatus == null && val.themeStatus == 1)">
            <i class="iconfont icon-livebroadcast"></i>
            <span>已结束</span>
          </p>
          <p class="video-status" style="background: rgba(0, 0, 0, .2)" v-if="val.playStatus == 2 || (val.playStatus == null && val.themeStatus == 0)">
        ...
        <div v-else>
          ...
          <p class="video-status" v-if="val.playStatus == 1">
            <i class="iconfont icon-livebroadcast"></i>
            <span>已结束</span>
          </p>
          <p class="video-status" style="background: rgba(0, 0, 0, .2)" v-if="val.playStatus == 2">
            <i class="iconfont icon-yugao"></i>
            <span>预告中</span>
          </p>
        </div>
