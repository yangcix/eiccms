          ...
          <div v-for="(chunk, chunkIndex) in periodAnalysis?.chunkedPeriods" :key="chunkIndex" >
            <table>
              ...
              <tr class="right-table-tr">
                ...
                <td
                    class="font-size-10"  style="text-align: left;position: relative;left: -20px;"
                >
    ...
    <div class="page-container" data-order="4">
      ...
      <section class="summary-section" style="margin-top: 60px">
        ...
        <ul style="margin-top: 20px;font-size: 16px;">
          ...
          <li style="margin-bottom: 10px;line-height: 22px">
            <span style="color: #f39d3c">教学风格兼顾性、教师推动有效学习：</span>教师均衡的教学风格利于学生思维激发，恰当的推动方法利于学习发生。
          </li>
        </ul>
      </section>
      <!-- 页脚，包含页码 -->
        ...
        <table class="data-table">
          ...
          <tr>
            ...
            <td class="orange-text-color font-size-14 td-text-center">{{
                teacherTeachAnalysis?.stTotalTeacher?.referene
              }} 分钟
            </td>
            <td>-</td>
          </tr>
          <tr>
            ...
            <td class="green-text-color font-size-14 td-text-center">{{ teacherTeachAnalysis?.speechSpeed?.value }}
              字/分钟
            </td>
            <td class="orange-text-color font-size-14 td-text-center">{{ teacherTeachAnalysis?.speechSpeed?.referene }}
              字/分钟
            </td>
            <td rowspan="2" class="font-size-12 font-color-c6c6c6">教师授课语速及凝炼度，会影响学生是否能及时
              处理教师所传递的信息。凝炼度数值越大表示单
              位时间内教师传递给学生的信息量越大。如果教
              师语速过快同时语言凝炼度较高，会导致学生无
              法跟上教师思路。课堂中教师习惯性的重复话语
              会使凝炼度降低<span class="red-text-color">【注3】。</span></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td rowspan="2" class="font-size-12 font-color-c6c6c6">教师情感饱满程度和比较强烈的积极话语次数，
              会吸引学生在课堂中更加投入，也反映出教学过
              程中教师的投入程度和对学生激励程度。
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="green-text-color font-size-14 td-text-center">{{ teacherTeachAnalysis?.sentiment?.value }}</td>
            <td class="orange-text-color font-size-14 td-text-center">{{
                teacherTeachAnalysis?.sentiment?.referene
              }}
            </td>
            <td class="font-size-12 font-color-c6c6c6">与教师进行课堂整顿和管控的程度相关，也与授
              课内容蕴含的情感相关。通常此类指标较高时，
              教师的管理风格偏严厉，容易让学生产生压迫感，
              不敢表达真实想法。教师在和学生的互动中可以
              增加鼓励和认可（参考1-4“积极话语次数”），
              来提升课堂互动质量和学生的投入程度。
            </td>
          </tr>
          <tr>
            ...
            <td class="font-size-12 font-color-c6c6c6">想象力：数值越大想象力越大，想象力高的场景
              更容易给学生留下深刻的印象，强化学生对内容
              的记忆和迁移。通常将两个关联度越低的事务联
              系起来，或者跨学科跨领域，则想象力指标就会
              提高。
            </td>
          </tr>
          <tr>
            ...
            <td class="font-size-12 font-color-c6c6c6">教师在授课时激励学生从不同角度思考，如“还
              有没有不同的想法？”，以有意义的次数来衡量
            </td>
          </tr>
          <tr>
...
<!--              {{ teacherTeachAnalysis?.clazzStructure?.value ? teacherTeachAnalysis?.clazzStructure?.value.split('').join('<br>') : '-'}}-->
              <span v-html="teacherTeachAnalysis?.clazzStructure?.value ? teacherTeachAnalysis.clazzStructure.value.split(' ').join('<br>') : '-'"></span>
            </td>
            <td class="orange-text-color font-size-14 td-text-center">-</td>
            <td class="font-size-12 font-color-c6c6c6">课堂教学常包含知识重温、学习目标设定和课堂
              总结，研究表明这些与强化知识记忆倾向正相关；
              如果与1-8“思维激发开放性”配合，会取得更
              全面的效果。
            </td>
          </tr>
          <tr>
            ...
            <td class="font-size-12 font-color-c6c6c6">教师的口头禅，因为不自觉使用，会影响教学效
              率甚至无意识对学生形成干扰。通常在语文课中，
              由于课文中经常会出现一些类似口头禅的语气
              词，在参考此指标时需注意区分。口头禅也会降
              低教师的语言凝炼度。
            </td>
          </tr>
          <tr>
            ...
            <td class="font-size-12 font-color-c6c6c6">知行教学风格的强烈程度，反映了教师知行教学
              个性的鲜明程度。过于强烈的个性，会使教师难
              以兼顾不同风格的学生<span class="red-text-color">【注4】。</span></td>
          </tr>
          </tbody>
        </table>
      </section>
    ...
    <div class="page-container" data-order="6">
      ...
      <section class="table-section">
        <table class="data-table">
          ...
          <tbody>
          <tr>
            <td rowspan="7" class="font-size-14"
                style="width: 40px;vertical-align: middle; writing-mode: vertical-lr; text-orientation: upright;padding-top: 28%">
              学生发言情况
            </td>
            <td class="font-size-14 td-text-center">发言总时长</td>
            <td class="green-text-color font-size-14 td-text-center">{{ studentAnalysis?.totalSpeechDuration?.value }}
            </td>
            <td class="font-size-14">-</td>
          </tr>
          <tr>
            <td class="font-size-14 td-text-center">发言主题的高频词</td>
            <td class="green-text-color font-size-14 td-text-center">{{ studentAnalysis?.speechTheme?.value }}</td>
            <td class="font-size-12 font-color-c6c6c6 td-text-center">学生课堂知识兴奋点或教师引导的学生关注点。
              所有学生发言提及的前几个高频主题。结合教师
              授课知识路径，了解学生关注重点，可以分析课
              堂知识引导是否和教师期望一致。
            </td>
          </tr>
          <tr>
            <td class="font-size-14 td-text-center">发言人次</td>
            <td class="green-text-color font-size-14 td-text-center">{{ studentAnalysis?.totalSpeechCount?.value }}</td>
            <td class="font-size-14 td-text-center">-</td>
          </tr>
          <tr>
            <td class="font-size-14 td-text-center">发言总字数</td>
            <td class="green-text-color font-size-14 td-text-center">{{ studentAnalysis?.totalSpeechWords?.value }}</td>
            <td class="font-size-12 td-text-center">-</td>
          </tr>
          <tr>
            <td class="font-size-14 td-text-center">发言平均时长</td>
            <td class="green-text-color font-size-14 td-text-center">{{ studentAnalysis?.speechDurationMean?.value }} 秒
            </td>
            <td class="font-size-12 td-text-center">-</td>
          </tr>
          <tr>
          ...
          <tr>
            <td colspan="2" class="font-size-14 td-text-center">
              发言时长分布
              <br>
              <img v-if="studentAnalysis.speechDistribution.chart.imageUri"
                   style="margin-top: 10px"
                   :width="studentAnalysis.speechDistribution.chart.width"
                   :height="studentAnalysis.speechDistribution.chart.height"
                   :src="studentAnalysis.speechDistribution.chart.imageUri" alt="发言时长分布图"/>
            </td> <!-- 合并两列 -->
            <td class="font-size-12 font-color-c6c6c6  td-text-center">时长分布图中，横轴表示学生发言时长分段，纵
              轴表示在对应时长中学生发言的次数。2秒以内
              （紫色）多表示学生对老师封闭性提问的响应
              （如：好不好？是多少？等类似提问），学生被动
              跟进教师的授课进度，难以引发学生的深入思考。
              4-30 秒区间（绿色，尤其是10-30秒）表明，在
              授课过程中，教师能有效鼓励学生主动思考，同
              时学生能有机会完整地表达个人想法。30秒以上，
              多表示学生在朗读或播放多媒体内容。
            </td>
          </tr>
          <tr>
            <td colspan="2" style="text-align: center; vertical-align: middle;" class="font-size-14 td-text-center">
              学生情感体验
            </td>
            <td class="green-text-color font-size-14 td-text-center">
              <!--              正极:00:01:41
                            ...
                            <br>
                            负极:00:01:30-->
              <p v-if="studentAnalysis?.speechSentiment?.value">
                <p v-for="(value, index ) in studentAnalysis?.speechSentiment?.value.split(' ')" :key="index">
                  {{ value }}
                </p>
              </p>
            </td>
            <td class="font-size-12 font-color-c6c6c6 td-text-center">正极表示学生课堂情绪比较积极，负极表示学生
              课堂情绪比较忧伤焦虑，用相应情感的累计时长
              来表示。教师需要根据课堂教学的情感价值观目
              标定位，检查目标达成情况。
            </td>
          </tr>
          <!-- 学习风格 -->
          <tr>
            ...
            <td class="green-text-color font-size-14  td-text-center">
              <!--              能动型:13%
                            ...
                            <br>
                            感悟型:21%-->
              <p v-if="studentAnalysis?.studyStyles?.value">
                <p v-for="(value, index ) in studentAnalysis?.studyStyles?.value.split(' ')" :key="index">
                  {{ value }}
                </p>
              </p>
            </td>
            <td class="font-size-12 font-color-c6c6c6  td-text-center">全部发言学生呈现的学习风格百分比分布，根据
              学习发生的知行理论，一般来说若兼顾了四种类
              型则说明教师能够在课堂中有效激发各种学习风
              格的学生。教师可根据教学设计和学科逻辑有意
              识地加大激发某类学习风格。
            </td>
          </tr>
          </tbody>
    ...
    <div class="page-container" data-order="7">
      ...
      <section class="table-section">
        <table class="data-table">
          ...
          <tr>
            <td class="font-size-14 td-text-center">授课语速</td>
            <td class="green-text-color font-size-14 td-text-center">{{ languageOriented?.speechSpeed?.value }} 字/分钟</td>
            <td class="orange-text-color font-size-14 td-text-center">{{ languageOriented?.speechSpeed?.referene }}
              字/分钟
            </td>
            <td rowspan="2" class="font-size-12 font-color-c6c6c6  td-text-center">教师授课语速及凝炼度，会影响学生是否能及时
              处理教师所传递的信息。凝炼度数值越大表示单
              位时间内教师传递给学生的信息量越大。如果教
              师语速过快同时语言凝炼度较高，会导致学生无
              法跟上教师思路。课堂中教师习惯性的重复话语
          ...
          <tr>
            <td class="font-size-14 td-text-center">语言凝练度</td>
            <td class="green-text-color font-size-14 td-text-center">{{ languageOriented?.averageInformation?.value }}
            </td>
            <td class="orange-text-color font-size-14 td-text-center">{{
          ...
          <tr>
            ...
            <td rowspan="2" class="font-size-12 font-color-c6c6c6  td-text-center">教师情感饱满程度和比较强烈的积极话语次数，
              会吸引学生在课堂中更加投入，也反映出教学过
              程中教师的投入程度和对学生激励程度。
            </td>
          </tr>
          ...
          <tr>
            ...
            <td class="green-text-color font-size-14 td-text-center">{{ languageOriented?.idreQuote?.value }}</td>
            <td class="orange-text-color font-size-14 td-text-center">-</td>
      ...
      <section class="knowledge-graph-section">
        ...
        <div style="width: 100%;margin-top: 30px;margin-bottom: 10px">
          ...
          <div class="right-table" v-if="knowledgeAssociations && knowledgeAssociations.length > 0">
            <div v-for="(chunk, chunkIndex) in chunkKnowledgeAssociations">
              <table>
                <tbody>
                <tr class="right-table-tr">
                  <td class="right-table-left-td1">授课主题</td>
                  <td v-for="(association, index) in chunk" :key="index" class="right-table-td-green">
                    {{ association?.clazzThemes?.join(" ") || '-' }}
                  </td>
                </tr>
                <tr class="right-table-tr">
                  <td class="right-table-left-td1">教师发言相关度<span class="red-text-color">【注1】</span></td>
                  <td v-for="(association, index) in chunk" :key="index" class="right-table-td-orange">
                ...
                <tr class="right-table-tr">
                  ...
                  <td v-for="(association, index) in chunk" :key="index" style="text-align: left;position: relative;left: -20px;">
...
&lt;!&ndash;                  {{
      ...
      <section class="summary-section">
        ...
        <div class="graph-container" ref="graphContainer" v-if="Object.keys(totalGraph).length > 0">
          ...
          <img style="margin: 0 auto;"
               height="300px"
               :src="totalGraph.chart.imageUri" alt="发言时长分布图"/>
        </div>
      </section>
      ...
      <section class="summary-section" style="width: 100%;height: 56%;">
        ...
        <div class="margin-top-30 graph">
          ...
          <div v-for="(graph, index) in graphs" :key="index" class="graph-item">
            ...
            <div class="graph-time">
              <span>
                {{ graph?.startTime }} - {{ graph?.stopTime }}
              </span>
            </div>
          </div>
        </div>
      ...
      <section class="table-section">
        <table class="data-table">
          ...
          <tr>
            ...
            <td class="green-text-color font-size-14 td-text-center">
              {{
                enlighten?.teacherAcceptance?.value ? parseFloat(enlighten?.teacherAcceptance?.value).toFixed(2) : '-'
              }}
            </td>
            <td class="orange-text-color font-size-14 td-text-center">{{
          ...
          <tr>
            ...
            <td class="green-text-color font-size-14 td-text-center">
              {{ enlighten?.discussions?.value ? enlighten?.discussions?.value + '次' : '-' }}</td>
            <td class="orange-text-color font-size-14 td-text-center">
      ...
      <section class="charts-section">
        <div class="charts-section-four">
          <div class="chart-item charts-section-one">
            ...
            <img v-if="clazzDistributionChart?.imageUri"
                 style="width: 300px;height: 300px;margin: 10px 0 0 30px;"
                 :src="clazzDistributionChart?.imageUri" alt="教师课堂投放信息的四何分布图"/>
          </div>
          <div class="chart-item charts-section-one">
            <p style="width: 260px;margin: 0 auto">2.课堂信息中问答类的四何分布情况</p>
            <img v-if="qaDistributionChart?.imageUri" style="width: 300px;height: 300px;margin: 10px 0 0 30px;"
                 :src="qaDistributionChart?.imageUri" alt="课堂信息中问答类的四何分布图"/>
          </div>
        </div>
      </section>
    ...
    <div class="page-container" data-order="10">
      ...
      <section class="interaction-section">
        ...
        <div class="interaction-data">
          <div class="left-section">
            <div class="info-item">
              <span class="label font-size-16">教师时长：</span><span class="value font-size-16">{{ stInteraction?.totalTeacher }}</span>
            </div>
            <div class="info-item">
              <span class="label font-size-16">学生时长：</span><span class="value font-size-16">{{ stInteraction?.totalStudent }}</span>
            </div>
            <div class="info-item">
          ...
          <div class="right-section">
            <div class="info-item">
              <span class="label font-size-16">互动次数：</span><span class="value font-size-16">{{ stInteraction?.numInteractions }}</span>
            </div>
            <div class="info-item">
              <span class="label font-size-16">师生互动比（师/生）：</span><span
                class="value font-size-16">{{ parseFloat(stInteraction?.ratioValue).toFixed(2) }}</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="curve-description">
        <div style="width: 50%;float: left">
          <img style="margin-top: 10px;width: 300px;height: 300px"
               :src="stInteraction.chart.imageUri" alt="师生互动情况"/>
        </div>
      ...
      <section class="scatter-plot-section">
        <div style="font-size: 16px; width: 100%;height: 120px;background-color: #fdf6ed;border-radius: 10px;">
          <p style="height: 5px;"></p>
          <p style="margin-left: 20px;margin-top: 20px;">
            本指标反映授课用语的发散程度，数值越大表示越发散，用语越有想象力。</p>
          <p style="margin-left: 20px;">根据数据的概率分布，本次课想象力激发较大。本次课平均想象力激发：
            <span class="value">
              {{ parseFloat(timeDistributed.mean).toFixed(2) }}
            </span>。
          </p>
          <p style="margin-left: 20px;color: #b2b1c2">参考值：《物理学的进化》的发散程度为：<span>{{
              timeDistributed?.low
            }}</span>；《三体》的发散程度为：<span>{{ timeDistributed?.high }}</span>。</p>
        </div>

        <img style="margin-top: 10px;width: 100%; height: 200px"
             :src="timeDistributed.chart.imageUri" alt="想象力激发"/>
      </section>
    ...
    <div class="page-container" data-order="11">
      <section class="ire-analysis-section margin-top-40">
        ...
        <p style="font-size: 16px;line-height: 1.5">
          I：教师发动提问，R：学生响应，D：学生讨论思考，E：教师评价反馈。教师发动提问 I，根据发动的问题分为五种：若何 (What
          if)、如何 (How)、是何 (What)、为何 (Why)、其他 (Other)。是何，多为封闭型问题；若何、如何、为何等则多为开放型问题。教师评价
          E，分为三种：否定 (-)、肯定 (+)、引述 (~)。
        </p>
        <p style="font-size: 16px;line-height: 1.5">
        ...
        <ul>
          <li><h5 style="font-size: 16px">1、简单型（{{ idre?.simples?.length }} 次）</h5></li>
          <ul>
            <li v-for="(item, index) in idre?.simples" :key="index">
              ...
              <span>：</span>
              <span v-for="(value, index) in item.states">
                <span>{{value.code}}</span>
                <span v-if="value.subCode && value.subCode.length > 0" style="font-size: 12px;position: relative" class="superscript">{{value.subCode}}</span>
                <span v-if="value.subCode && value.subCode.length > 1">&nbsp;</span>
              </span>
            </li>
          </ul>
          <li><h5 style="font-size: 16px">2、追问型（{{ idre?.repeats?.length }} 次）</h5></li>
          <ul>
          ...
          <li><h5 style="font-size: 16px">3、学生讨论思考再答型（{{ idre?.discussions?.length }} 次），学生平均练习思考时间
            {{ idre?.discussionMeanDuration }} 秒</h5></li>
          <ul>
    ...
    <div class="page-container" data-order="12">
        ...
        <table class="data-table">
          ...
          <tr>
            ...
            <td class="green-text-color font-size-14 td-text-center">
              ...
              <p v-if="facilitationMethod?.kaDesign?.value">
                <p v-for="(value, index ) in facilitationMethod?.kaDesign?.value.split(' ')" :key="index">
                  {{ value }}
                </p>
              </p>
            </td>
            <td class="orange-text-color font-size-14 td-text-center">{{ facilitationMethod?.kaDesign?.referene }}</td>
            <td class="font-size-12 font-color-c6c6c6  td-text-center">
      ...
      <section class="chart-section margin-top-60">
        ...
        <div style="width: 100%;height: 100px; display: flex;background-color: #fdf6ed;border-radius: 10px;"
             class="margin-top-30">
...
<!--            根据教学风格在各个象限的概率分布，本课堂侧重于<span class="orange font-weight">概念→思想练习</span>的方式，偏向激发<span
        ...
        <div class="chart-section-data">
          ...
          <div style="float: left;flex: 1;box-sizing: border-box;">
            <img style="margin-top: 10px; width: 380px; height: 330px;" :src="kaVo.chart.imageUri" alt="想象力激发"/>
          </div>
          <div class="chart-section-left line-height font-size-16">
            ...
            <p>
              ...
              <span class="orange font-weight">{{ parseFloat(kaVo?.teachStyleIntensity).toFixed(2) }}</span>（数值越大表示越强烈）。
            </p>
            <table>
              <thead>
              <tr>
      ...
      <section style="width: 100%;height: 400px;">
        ...
        <div class="chart-section-left line-height">
          ...
          <table style="margin-top: 40px;line-height: 1.5">
            <thead>
            <tr>
              <th style="width: 160px;" class="text-align-left">学生学习风格<span class="red-text-color">【注6】</span>
              </th>
              <th style="width: 100px;">百分比</th>
            </tr>
            </thead>
      ...
      <section class="table-section">
        <table class="data-table">
          ...
          <tr>
            ...
            <td class="font-size-14 orange-text-color td-text-center">{{ studentFias?.pir?.reference }}</td>
            <td class="font-size-12 font-color-c6c6c6  td-text-center">
          ...
          <tr>
            ...
            <td class="font-size-14 orange-text-color td-text-center">{{ studentFias?.pssr?.reference }}</td>
            <td class="font-size-12 font-color-c6c6c6  td-text-center">
          ...
          <tr>
            ...
            <td class="font-size-14 green-text-color td-text-center">{{ studentFias?.stQaCount?.value }} 次</td>
          ...
          <tr>
            ...
            <td class="font-size-14 orange-text-color td-text-center">
              {{
                studentFias?.studentInitiativeCount?.reference ? studentFias?.studentInitiativeCount?.reference : '-'
              }}
            </td>
            <td class="font-size-12 font-color-c6c6c6  td-text-center">
              -
          ...
          <tr class="font-size-14 td-text-center">
            <td class="font-size-14 td-text-center">发言的充分表达量</td>
            <td class="font-size-14 green-text-color td-text-center">{{ studentFias?.speechAdequateExpression?.value }}
              次
            </td>
            <td class="font-size-14 orange-text-color td-text-center">
              {{
                studentFias?.speechAdequateExpression?.reference ? studentFias?.speechAdequateExpression?.reference : '-'
              }}
            </td>
            <td class="font-size-12 font-color-c6c6c6  td-text-center">
              学生发言在10-30秒的次数。
          ...
          <tr class="font-size-14 ">
            <td class="font-size-14 td-text-center">发言总时长</td>
            <td class="font-size-14 green-text-color td-text-center">{{ studentFias?.totalSpeechDuration?.value }}</td>
            <td class="font-size-14 orange-text-color td-text-center">
              {{ studentFias?.totalSpeechDuration?.reference ? studentFias?.totalSpeechDuration?.reference : '-' }}
            </td>
            <td class="font-size-12 font-color-c6c6c6  td-text-center">
              -
            </td>
      ...
      <section class="brain-stimulation-section">
        <div class="brain-stimulation-top">
          <p style="margin-left: 40px;">
            ...
            <span style="margin-left: 200px">左右脑比例（左/右）<span class="red-text-color">【注5】</span>：
      ...
      <section class="emotion-experience-section">
        <div class="emotion-data">
          <div style="width: 90%;margin: 0 auto;">
            <p>
              <span>正极时长：<span class="orange">{{ studentSentiment?.totalPos }}</span></span>
              <span style="margin-left: 80px;">中性时长：<span class="orange">{{
                  studentSentiment?.totalNeu
                }}</span></span>
              <span style="margin-left: 80px;">负极时长：<span class="orange">{{
                  studentSentiment?.totalNeg
                }}</span></span>
            </p>
          </div>
        </div>
...
<!--    <div class="page-container" data-order="15">
    ...
    <div class="page-container" data-order="15">
      ...
      <section class="annotation-section margin-bottom-30 margin-top-40">
        <p><span class="red-text-color">【注 1】</span> 师生发言相关度：衡量教师授课与学生发言的相关程度，取值范围
          0~1。完全相关则等于
          1，完全不相关或学生发言过少则等于 0。相关度高，表示学生认真听课，能跟随教师授课节奏。相关度低，多数表示学生没有跟随教师授课，也可能表示学生产生了创造性联想。
        </p>
        <p><span class="red-text-color">【注 2】</span>
        ...
        <p><span class="red-text-color">【注 3】</span> 凝练度是用单位时间教师讲话所包含的信息量(香农理论)来衡量。</p>
        <p><span class="red-text-color">【注 4】</span> 知行教学风格强烈程度：基于教师课堂知识传递联合采用概念抽象（what）—场景假设（what
          if）—为什么（why）—怎么样（how）四种方式的分布情况，以此计算偏离零点的程度，用来衡量教师传递课堂知识偏向某方式的程度。数值越小表示教师的教学风格能够更好的兼顾不同学习风格的学生，侧面反应教师教学经验的成熟度越高。
        </p>
        <p><span class="red-text-color">【注 5】</span>
  ...
  methods: {
      ...
      try {
        ...
        if (res.code == 200) {
          this.$nextTick((() => {
            ...
            this.integralAnalysis.facilitationSummaryText = res.data?.summary?.integralAnalysis?.facilitationSummaryText;
            ...
            this.clazzDistributionChart = res.data?.teacher?.inspireCreativity?.fourHo?.clazzDistributionChart;
            ...
            if (this.knowledgeAssociations !== res.data?.teacher?.knowledgeAssociation?.knowledgeAssociations) {
    ...
    initIntegralAnalysisText() {
      ...
      if (this.integralAnalysis?.summaryText.length > 0) {
        integralAnalysisText
            .concat(
                this.integralAnalysis?.summaryText
                    .replace("class=\"highlight-g\"", "style=\"color: #e6ecff\"")
            );
      }
      if (this.periodAnalysis?.summaryText.length > 0) {
        integralAnalysisText.concat(
            this.integralAnalysis?.summaryText
                .replace("class=\"highlight-y\"", "style=\"color: #fff0de\"")
        );
      }
...
//margin-bottom: 40px; /* 确保页码有足够的空间 */ //height: auto; height: 1123px; /* A4 高度（300 DPI）3508 1169 */ //background-color: #f1f2f4; background-color: white; page-break-before: always; /* 确保每一页从新的一页开始 */ padding: 20px; box-sizing: border-box; display: block; margin-bottom: 10px;
}
...
.graph-img {
  float: left;
//width: calc(50% - 40px); width: calc(100% - 50px); /* 图片宽度占满容器 */ //height: calc(50% - 2px); height: auto; /* 高度自动调整 */ border: 1px solid #efe8e3; margin-left: 25px;
}
...
.graph-img img {
//width: calc(88% - 2px); /* 固定宽度 */ width: 100%; /* 固定宽度 */ height: auto; /* 高度自动调整 */
}
...
.highlight-g,.highlight-b,.highlight-a,.highlight-c,.highlight-d,.highlight-e,.highlight-f{
  color: #F99723;
}
...
.brain-stimulation-top {
  ...
  height: 100px;
  background-color: #fdf6ed;
//display: flex; justify-content: center; /* 水平居中 */ padding-top: 5px; border-radius: 10px;
}
