        ...
        <div class="main-wrap">
            ...
            <div class="data-table table-border">
                <el-table v-loading="loading" :data="tableData" style="width: 100%">
                    ...
                    <el-table-column prop="numCount" align="center" label="课程进度">
                        <template slot-scope="scope">
                    ...
                    <el-table-column prop="startTime" align="center" min-width="110" label="最新开课时间">
                        <template slot-scope="scope">
    ...
    methods: {
        ...
        release(type, val) {
            if (type == 0) {
                ...
                this.$axios
                    .post('/sm/habitus/release', {id: this.releaseRow.id, endTime: this.releaseRow.endTime})
                    .then((res) => {
                        if (res.code == 200) {
