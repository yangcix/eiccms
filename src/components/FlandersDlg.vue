            ...
            >
                <template #header="{column}">
                    <div class="table-header">
                        {{ column.showLabel
                        }}<el-tooltip :content="column.label" placement="top" popper-class="tooltip-content">
                            <i class="el-icon-question"></i>
                        </el-tooltip>
                    </div>
                </template>
...
export default {
    ...
    data() {
        return {
            columns: [
                ...
                {
                    prop: 'teacherResponseRateTrr',
                    label: '教师正面回应学生比率(TTR)',
                    sortable: 'custom',
                    slotHeader: true,
                    showLabel: 'TTR',
                },
                {
                    prop: 'teacherQuestionRateTqr',
                    label: '教师发问比率(TQR)',
                    sortable: 'custom',
                    slotHeader: true,
                    showLabel: 'TQR',
                ...
                {
                    prop: 'teacherFocusRateCcr',
                    label: '教师聚焦讲授与提问比率(CCR)',
                    sortable: 'custom',
                    slotHeader: true,
                    showLabel: 'CCR',
                },
                {
                    prop: 'interactionStabilityRateSsR',
                    label: '师生话题交流稳定比率(SSR)',
                    sortable: 'custom',
                    slotHeader: true,
                    showLabel: 'SSR',
                },
                {
                    prop: 'studentExpressionRatePssr',
                    label: '学生表达稳定比率(PSSR)',
                    sortable: 'custom',
                    slotHeader: true,
                    showLabel: 'PSSR',
    ...
    methods: {
        getTableData(params) {
            this.$comjs.getDlgTableData(params, '/ai/bigdata/getFlandersInteractionStatsList', this);
        },
        operateColumns(val) {
