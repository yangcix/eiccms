      ...
      <el-form :model="form" ref="form" label-width="120px">
        ...
        <el-form-item label="剩余分析次数：" v-if="openEnable" required>
          <div>
            ...
            <div
                style="background-color: #fff7ea;width: 340px;float: left;margin-left: 20px;color: #f59a23;border-radius: 5px">
        ...
        <el-form-item label="预警次数：" v-if="openEnable" required>
          <el-input-number v-model="form.warningNumber" :min="1" :max="999999" label="预警次数"></el-input-number>
        </el-form-item>

        <el-form-item label="提醒人员：" v-if="openEnable" required>
          <el-select multiple filterable v-model="form.users"  style="width: 320px;" placeholder="请选择提醒人员">
