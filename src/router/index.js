...
const routes = [
    {
        ...
        path: '/interactlogin',
        name: 'interactlogin',
        component: () => import(/* webpackChunkName: "interactlogin" */ '@/views/client/interact/InteractLogin.vue'),
    },
    {
        //主讲教室
        path: '/mainroom',
        name: 'mainroom',
        component: () => import(/* webpackChunkName: "mainroom" */ '@/views/client/interact/MainRoom.vue'),
    },
    {
        //副讲教室
        path: '/assistantroom',
        name: 'assistantroom',
        component: () => import(/* webpackChunkName: "assistantroom" */ '@/views/client/interact/AssistantRoom.vue'),
    },
    {
        //常态化互动登录
    ...
    },
    {
        ...
        path: '/normalmainroom',
        name: 'normalmainroom',
        component: () => import(/* webpackChunkName: "mainroom" */ '@/views/client/normalInteract/MainRoom.vue'),
    },
    {
        //常态化副讲教室
    ...
    },
    {
        ...
        path: '/helpHome',
        name: 'helpHome',
        component: () => import(/* webpackChunkName: "helpHome" */ '@/views/system/helpHome.vue'),
    },
    {
        //努比ai报告页
        path: '/aiReport',
        name: 'aiReport',
        component: () => import(/* webpackChunkName: "helpHome" */ '@/views/learnSys/aiclass/aiReport.vue'),
    },
    {
        //努比听评课活动ai报告页
        path: '/commentReport',
        name: 'commentReport',
        component: () => import(/* webpackChunkName: "helpHome" */ '@/views/system/evaluation/commentReport.vue'),
    },
    {
        //后台系统
        path: '/sys',
        name: 'sys',
        redirect: '/sys/home',
        component: () => import(/* webpackChunkName: "index" */ '@/views/system/Index.vue'),
        children: [
            {
                //概览
                path: 'home',
                name: 'syshome',
                component: () => import(/* webpackChunkName: "syshome" */ '@/views/system/Home.vue'),
            },
            {
                //用户管理
                path: 'user',
                name: 'sysuser',
                component: () => import(/* webpackChunkName: "sysuser" */ '@/views/system/member/User.vue'),
            },
            {
                //用户管理
                path: 'org',
                name: 'sysorg',
                component: () => import(/* webpackChunkName: "sysorg" */ '@/views/system/member/Organization.vue'),
            },
            {
                //角色管理
                path: 'role',
                name: 'sysrole',
                meta: {keepAlive: true},
                component: () => import(/* webpackChunkName: "sysrole" */ '@/views/system/member/Role.vue'),
            },
            {
                //权限授权
                path: '/roleEdit',
                name: 'roleEdit',
                component: () => import(/* webpackChunkName: "sysrole" */ '@/views/system/member/RoleEdit.vue'),
            },
            {
                //用户组
                path: 'group',
                name: 'sysgroup',
                component: () => import(/* webpackChunkName: "sysgroup" */ '@/views/system/member/Group.vue'),
            },
            {
                //班级管理
                path: '/sm/class',
                name: 'sysclass',
                component: () => import(/* webpackChunkName: "sysclass" */ '@/views/system/member/Class.vue'),
            },
            {
                //年级管理
                path: '/sm/grade',
                name: 'smgrade',
                component: () => import(/* webpackChunkName: "smgrade" */ '@/views/system/member/Grade.vue'),
            },
            {
                //系统配置
                path: 'system',
                name: 'system',
                component: () => import(/* webpackChunkName: "system" */ '@/views/system/base/System.vue'),
            },
            {
                //广告配置
                path: 'ad',
                name: 'ad',
                component: () => import(/* webpackChunkName: "ad" */ '@/views/system/base/Adver.vue'),
            },
            {
                //用户登录日志
                path: '/sys/user/login/log',
                name: 'userLoginLogs',
                component: () => import(/* webpackChunkName: "help" */ '@/views/system/base/userLoginLogs.vue'),
            },
            {
                //敏感操作日志
                path: '/sys/sensitive',
                name: 'sensitive',
                component: () => import(/* webpackChunkName: "help" */ '@/views/system/base/sensitive.vue'),
            },
            {
                //帮助中心
                path: '/sys/help',
                name: 'help',
                meta: {keepAlive: true},
                component: () => import(/* webpackChunkName: "help" */ '@/views/system/base/Help.vue'),
            },
            {
                // 帮助中心新增编辑
                path: '/sys/helpaddedit',
                name: 'helpaddedit',
                component: () => import(/* webpackChunkName: "helpaddedit" */ '@/views/system/base/HelpAddEdit.vue'),
            },
            {
                //教学楼管理
                path: 'teachBuild',
                name: 'systeachbuild',
                component: () => import(/* webpackChunkName: "systeachbuild" */ '@/views/system/base/TeachBuild.vue'),
            },
            {
                //教室管理
                path: 'classroom',
                name: 'sysclassroom',
                component: () => import(/* webpackChunkName: "sysclassroom" */ '@/views/system/base/Classroom.vue'),
            },
            {
                //服务器管理
                path: 'serverConfig',
                name: 'sysserver',
                component: () => import(/* webpackChunkName: "sysserver" */ '@/views/system/equipment/Server.vue'),
            },
            {
                //终端管理
                path: 'terminal',
                name: 'systerminal',
                component: () => import(/* webpackChunkName: "sysserver" */ '@/views/system/equipment/Terminal.vue'),
            },
            {
                //客户端管理
                path: 'clientManagement',
                name: 'clientManagement',
                component: () => import('@/views/system/equipment/clientManagement.vue'),
            },
            {
                // 类型管理 new
                path: '/sm/category',
                name: 'smcategory',
                component: () => import(/* webpackChunkName: "sysserver" */ '@/views/system/video/Ctegory.vue'),
            },
            {
                //类型管理 分类管理
                path: '/sm/label',
                name: 'smlabel',
                component: () => import(/* webpackChunkName: "sysserver" */ '@/views/system/video/Type.vue'),
            },
            {
                //主题管理
                path: '/sm/theme',
                name: 'smtheme',
                meta: {keepAlive: true},
                component: () => import(/* webpackChunkName: "smtheme" */ '@/views/system/video/Theme.vue'),
            },
            {
                //主题新增编辑
                path: '/sm/themeaddedit',
                name: 'themeaddedit',
                component: () => import(/* webpackChunkName: "themeaddedit" */ '@/views/system/video/ThemeAddEdit.vue'),
            },
            {
                //主题详情
                path: '/sm/themedetail',
                name: 'themedetail',
                component: () => import(/* webpackChunkName: "themedetail" */ '@/views/system/video/ThemeDetail.vue'),
            },
            {
                //回放
                path: '/sm/themeplayback', // playback  themeplayback
                name: 'themeplayback',
                component: () => import(/* webpackChunkName: "themeplayback" */ '@/views/system/video/PlayBack.vue'),
            },
            {
                //菜单管理
                path: 'menu',
                name: 'sysmenu',
                component: () => import(/* webpackChunkName: "sysserver" */ '@/views/system/system/Menu.vue'),
            },
            {
                //日志管理
                path: 'log',
                name: 'syslog',
                component: () => import(/* webpackChunkName: "sysserver" */ '@/views/system/system/Log.vue'),
            },
            {
                //视频管理
                path: '/sm/file',
                name: 'smfile',
                meta: {keepAlive: true},
                component: () => import(/* webpackChunkName: "smfile" */ '@/views/system/videoManage/File.vue'),
            },
            {
                // 剪辑管理
                path: '/sm/clip',
                name: 'smclip',
                component: () => import(/* webpackChunkName: "smclip" */ '@/views/system/videoManage/Clip.vue'),
            },
            {
                // 视频合并
                path: '/sm/merge',
                name: 'smmerge',
                component: () => import(/* webpackChunkName: "smclip" */ '@/views/system/videoManage/merge.vue'),
            },
            {
                //公网点播进度
            ...
            },
            {
                ...
                name: 'interact',
                meta: {keepAlive: true},
                component: () => import(/* webpackChunkName: "interact" */ '@/views/system/interact/Interact.vue'),
            },
            {
                //互动主题详情
            ...
            ,
            {
                ...
                name: 'habitus',
                meta: {keepAlive: true},
                component: () => import(/* habitus: "habitus" */ '@/views/system/normalInteract/Interact.vue'),
            },
            {
                //常态化互动主题详情
                ...
                component: () =>
                    import(
                        /* webpackChunkName: "interactivedetail" */ '@/views/system/normalInteract/InteractDetail.vue'
                    ),
            },
            {
                //常态化互动主题新增编辑
                ...
                component: () =>
                    import(
                        /* webpackChunkName: "interactiveaddedit" */ '@/views/system/normalInteract/InteractAddEdit.vue'
                    ),
            },
            {
                //校外互动主题管理
                ...
                component: () =>
                    import(
                        /* webpackChunkName: "interactOutdoors" */ '@/views/system/interactOutdoors/InteractOutdoors.vue'
                    ),
            },
            {
                //校外互动主题详情
                ...
                component: () =>
                    import(
                        /* webpackChunkName: "interactOutDetail" */ '@/views/system/interactOutdoors/InteractOutDetail.vue'
                    ),
            },
            {
                //校外互动主题新增编辑
                ...
                component: () =>
                    import(
                        /* webpackChunkName: "interactOutAddEdit" */ '@/views/system/interactOutdoors/InteractOutAddEdit.vue'
                    ),
            },
            {
                //学校管理
                ...
                name: 'school',
                component: () => import(/* webpackChunkName: "school" */ '@/views/system/schoolManage/school.vue'),
            },
            {
                // 评课管理
                path: '/sm/comment',
                name: 'comment',
                meta: {keepAlive: true},
                component: () => import(/* webpackChunkName: "interact" */ '@/views/system/evaluation/Comment.vue'),
            },
            {
                // 评课管理新增编辑
            ...
            },
            {
                ...
                component: () =>
                    import(
                        /* webpackChunkName: "interact" */ '@/views/system/evaluationTemp/EvaluationTempAddEdit.vue'
                    ),
            },
            {
                // 大单元管理
            ...
            },
            {
                ...
                component: () =>
                    import(
                        /* webpackChunkName: "syslessontemp" */ '@/views/recorderSys/recordLessonTable/lessonTemp.vue'
                    ),
            },
            {
                // 智能录播  课表模板新增  编辑
                ...
                component: () =>
                    import(
                        /* webpackChunkName: "syslessontempedit" */ '@/views/recorderSys/recordLessonTable/lessonTempAdd.vue'
                    ),
            },
            {
                // 智能录播 课表管理
                ...
                component: () =>
                    import(
                        /* webpackChunkName: "sysrecordlesson" */ '@/views/recorderSys/recordLesson/recordLesson.vue'
                    ),
            },
            {
                // 智能录播 课表管理  新增  编辑
                ...
                component: () =>
                    import(
                        /* webpackChunkName: "sysrecordlessonedit" */ '@/views/recorderSys/recordLesson/recordLessonAdd.vue'
                    ),
            },
            {
                // 智能录播 录播视频列表
            ...
            },
            {
                ...
                name: 'smaiclass',
                meta: {keepAlive: true},
                component: () => import(/* webpackChunkName: "smaiclass" */ '@/views/learnSys/aiclass/aiclass.vue'),
            },
        ...
        name: 'aiRecharge',
        meta:{keepAlive:true},
        component: () => import(/!* webpackChunkName: "smaiclass" *!/ '@/views/learnSys/aiclass/aiclassRecharge.vue')
      },*/
            ...
            },
            {
                ...
                path: '/aiConfig',
                name: '/aiConfig',
                component: () => import(/* webpackChunkName: "smaiclass" */ '@/views/learnSys/config/index.vue'),
            },
            {
                // AI分析池管理
                path: '/aiDistribution',
                name: 'smdistribution',
                component: () => import(/* webpackChunkName: "smaiclass" */ '@/views/learnSys/config/distribution.vue'),
            },
            {
                // AI分析次数管理
            ...
            },
            {
                ...
                component: () =>
                    import(
                        /* webpackChunkName: "lessonPlanAnalysis" */ '@/views/learnSys/lessonPlanAnalysis/lessonPlanAnalysis.vue'
                    ),
            },
            {
                // 教案分析编辑页
                ...
                component: () =>
                    import(
                        /* webpackChunkName: "lessonPlanAnalysis" */ '@/views/learnSys/lessonPlanAnalysis/lessonPlanAnalysisEdit.vue'
                    ),
            },
            {
                // 分析次数预警
            ...
            },
            {
                ...
                name: 'tryout',
                component: () => import('@/views/system/tryout.vue'),
            },
            {
                // 教学建议配置
            ...
            },
            {
                ...
                component: () =>
                    import(
                        /* webpackChunkName: "smaiclass" */ '@/views/learnSys/config/TeachingSuggestionConfigEdit.vue'
                    ),
            },
            {
                // 版本管理
    ...
    },
    {
        ...
        path: '/transit',
        name: 'transit',
        component: () => import(/* webpackChunkName: "transit" */ '@/views/system/transit.vue'),
    },
    {
        //后台登录
        path: '/login',
    ...
    },
    {
        ...
        path: '/initsystem',
        name: 'initsystem',
        component: () => import(/* webpackChunkName: "initsystem" */ '@/views/system/InitSystem.vue'),
    },
    {
        //数据看板
        path: '/dataBoard',
        name: 'dataBoard',
        component: () => import(/* webpackChunkName: "home" */ '@/views/client/dataBoard.vue'),
    },
    {
        //大数据分析
        path: '/bigData',
        name: 'bigData',
        component: () => import(/* webpackChunkName: "bigData" */ '@/views/system/details.vue'),
    },
    {
        // 到期页面
        path: '/expire',
        name: 'expire',
        component: () => import('@/views/system/expire.vue'),
    },
    {
        // 福龙城URL跳转登录
        path: '/loginRedirect',
        name: 'loginRedirect',
        component: () => import(/* webpackChunkName: "training" */ '@/views/system/LoginRedirect.vue'),
    },
    {
        // AI教师版报告（新版页面）
        ...
        meta: {keepAlive: true},
        component: () => import(/* webpackChunkName: "lessonPlanAnalysis" */ '@/views/aiReport/AiTeacherReport.vue'),
    },
    {
        // 大数据报告
        ...
        name: 'bigDataReport',
        meta: {keepAlive: true},
        component: () => import(/* webpackChunkName: "lessonPlanAnalysis" */ '@/views/aiReport/bigDataReport.vue'),
    },
    {
        // 甘肃URL跳转登录
        path: '/gansu/loginRedirect',
        name: 'ganSuLoginRedirect',
        component: () => import(/* webpackChunkName: "training" */ '@/views/system/GanSuLoginRedirect.vue'),
    },
];
                ...
                router.addRoute({
                    ...
                    children: [
                        ...
                        },
                        {
                            ...
                            path: 'userhome',
                            name: 'userhome',
                            component: () => import(/* userhome: "userhome" */ '@/views/newClient/Userhome.vue'),
                        },
                        {
                            //实时研修
                            path: 'training',
                            name: 'training',
                            component: () => import(/* webpackChunkName: "training" */ '@/views/client/Training.vue'),
                        },
                    ],
                });
            } else {
