...
axios.interceptors.response.use(
    (response) => {
        if (
            response.config.url == '/auth/signOut' ||
            response.config.url == '/auth/signOutBackStage' ||
            response.config.url == '/sys/user/updatePwdBackStage' ||
            response.config.url == '/sys/user/updatePwd'
        ) {
        ...
        if (
            resUrl.includes('/sys/user/importUserInfo') ||
