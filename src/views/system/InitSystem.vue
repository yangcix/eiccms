<template>
    <div class="init-wrap">
        ...
        <div class="content-wrap step3" v-show="stepIndex == 7 && version == 3">
            ...
            <div class="content">
                <el-select v-model="mapValue" placeholder="请选择">
                    <el-option v-for="item in mapOption" :key="item.id" :label="item.label" :value="item.id">
                    </el-option>
                </el-select>
            </div>
            <div class="step">
...
.content-wrap {
    ...
    .content {
        ...
        .bgc1 {
            background: url(../../assets/imgs/init-icon4.png) no-repeat center/100% 100%;
        }
        .bgc2 {
            background: url(../../assets/imgs/init-icon5.png) no-repeat center/100% 100%;
        }
        .bgc3 {
            background: url(../../assets/imgs/init-icon1.png) no-repeat center/100% 100%;
        }
        .bgc4 {
            background: url(../../assets/imgs/init-icon2.png) no-repeat center/100% 100%;
        }
        .bgc5 {
            background: url(../../assets/imgs/init-icon3.png) no-repeat center/100% 100%;
        }
        .bgc6 {
            background: url(../../assets/imgs/init-icon6.png) no-repeat center/100% 100%;
        }
    }
    .step {
        display: flex;
