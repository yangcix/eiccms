	...
	<div class="init-wrap">
		...
		<div>
			<el-dialog
				...
				<div class="login-content">
					<p>用户名：<el-input class="input" @keyup.native.enter="handleLogin" v-model.trim="admin.account"></el-input></p>
		...
		<div  class="content-wrap step3" v-show="stepIndex == 3 && version == 3">
			...
			<div class="step">
				...
				<el-button type="primary" @click="stepIndex = 4">下一步</el-button>
			</div>
		</div>

		<div  class="content-wrap step3" v-show="stepIndex == 4 && (version == 3 || version == 2)">
			<p class="set">选择巡课单位</p>
			<div class="content">
				<div class="item bgc5" @click="tourUnit = 1" :class="tourUnit == 1 ? 'active' : ''">
					<p class="title">教育局</p>
				</div>
				<div class="item bgc4" @click="tourUnit = 2" :class="tourUnit == 2 ? 'active' : ''">
					<p class="title">教学楼</p>
				</div>
			</div>
			<div class="step">
				<el-button type="primary" @click="netTypeGo">上一步</el-button>
				<el-button type="primary" @click="netTypeSet">下一步</el-button>
			</div>
		</div>

		<div  class="content-wrap step3" v-show="stepIndex == 5 && version == 3">
			...
			<div class="step">
				<el-button type="primary" @click="uiTypeGo">上一步</el-button>
				<el-button type="primary" @click="uiTypeSet">下一步</el-button>
			</div>
		</div>

		<div  class="content-wrap step3" v-show="stepIndex == 6">
		...
		<div  class="content-wrap" v-show="stepIndex == 7">
		...
		<div  class="content-wrap step3" v-show="stepIndex == 8 && version == 3">
          ...
          <el-option
			...
			<div class="step">
				<el-button type="primary" @click="stepIndex = 7">上一步</el-button>
				<el-button type="primary" @click="stepIndex = 9">下一步</el-button>
			</div>
		</div>
		<div  class="content-wrap" v-show="stepIndex == 9">
		...
		<div  class="content-wrap step1" v-show="stepIndex == 10">
			<div class="content">
			...
			passwordSet(){
				if(!this.password){
					...
					let data = {
						...
						tourUnit: this.version == 1 ? '' : this.tourUnit,
