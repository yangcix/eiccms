...
export default {
    ...
    data() {
        return {
            columns: [
                ...
                {prop: 'whatRatio', label: '是何', width: '100', sortable: 'custom', suffix: '%'},
                {prop: 'ifHowRatio', label: '若何', width: '100', sortable: 'custom', suffix: '%'},
                {prop: 'howRatio', label: '如何', width: '100', sortable: 'custom', suffix: '%'},
                {prop: 'whyRatio', label: '为何', width: '100', sortable: 'custom', suffix: '%'},
    ...
    methods: {
        getTableData(params) {
            if (this.chartName == '教师课堂投放信息') {
                this.$comjs.getDlgTableData(params, '/ai/bigdata/getTeacherClassroomDeliveryList', this);
            } else {
                this.$comjs.getDlgTableData(params, '/ai/bigdata/getQuestionStatsList', this);
            }
        },
        operateColumns(val) {
