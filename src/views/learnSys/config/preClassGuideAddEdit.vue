        ...
        <div class="content-wrap">
            <div class="item-scroll">
                <div class="box">
                    ...
                    <div class="item-wrap">
                        <p>优先使用：</p>
                        <el-select :popper-append-to-body="false" v-model="addEditInfo.useId" class="width-2">
...
export default {
    ...
    methods: {
        ...
        //编辑获取主体信息
        getThemeInfo() {
            this.$axios.get('/preClassGuide/info', {id: this.themeId}).then((res) => {
        ...
        goBack() {
            if (this.$route.query.mode) {
                this.$router.push('/preClassGuide');
            } else {
                this.$router.go(-1);
            }
        },
        ...
        httpRequest(isTranslationPending) {
            ...
            this.$axios.post('/preClassGuide/check', judgeData).then((res) => {
                if (res.code == 200) {
                    formData.append('useId', this.addEditInfo.useId);
        ...
        getHistoryCourseList() {
            this.$axios.get('/getHistoryCourseList').then((res) => {
