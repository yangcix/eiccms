      ...
      <div class="evaluation-wrap">
        ...
        <el-tabs v-model="activeName" style="pointer-events: none;">
          ...
          <div class="evaluation-content">
            ...
            <el-table-column v-if="item.itemList && item.itemList[0] && (item.itemList[0].type == 0 || item.itemList[0].type == 2)" align="center" label="分值">
            ...
            <el-table-column v-if="item.itemList && item.itemList[0] && (item.itemList[0].type == 0 || item.itemList[0].type == 2)" align="center" label="评分" width="250px">
              <template slot-scope="scope">
            ...
            <el-table-column v-if="item.itemList && item.itemList[0] && (item.itemList[0].type == 1 || item.itemList[0].type == 2)" align="center" label="评语" style="min-width: 350px;">
              <template slot-scope="scope">
