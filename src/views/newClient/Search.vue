<template>
	<div class="">
		...
		<div class="video-catalog">
			...
			<VideoList :videoList="videoList" :type="activeIndex" v-show="activeIndex == 0"></VideoList>
			<VideoLists :videoList="videoList" :type="activeIndex" v-show="activeIndex == 2"></VideoLists>
...
<script>
	...
	import InteractList from './components/VideoList1.vue'
	...
	export default {
		...
		components: {VideoList, VideoLists, Swiper, InteractList},
		mounted() {
			this.getVideolist();
			this.visity();
		},
		...
		methods: {
			...
			//获取视频
			getVideolist(){
				console.log(this.activeIndex,'vvs')
