...
*/
  function getCurveByTwoPoints(obj1, obj2, count) {
      ...
      var count = count || 40;
      // 曲线是由一些小的线段组成的，这个表示这个曲线所有到的折线的个数
      var isFuture = false;
  ...
  var ForceEdgeBundling = function ForceEdgeBundling() {
      ...
      forcebundle.edges = function(ll) {
          if (arguments.length == 0) {
              ...
              //remove edges to from to the same point
          }
          return forcebundle;
      }
      ;
  ...
  var AnimationLayer = function(_BaseLayer) {
      ...
      createClass(AnimationLayer, [{
          ...
          value: function _canvasUpdate() {
              ...
              var nwMc = new BMap$2.Pixel(mcCenter.x - map.getSize().width / 2 * zoomUnit,mcCenter.y + map.getSize().height / 2 * zoomUnit);
              //左上角墨卡托坐标
  ...
  if (typeof Cesium !== 'undefined') {
       ...
       */
          function MapVLayer(viewer, dataset, options, container) {
              ...
              this.mapvBaseLayer = new MapVRenderer$1(viewer,dataset,options,this),
