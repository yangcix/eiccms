...
export default {
  ...
  methods: {
    play(val) {
      ...
      // if(val.isHabitus == 1) {
      // 	if(val.type == 1 ){
      // 		playUrl = window.origin + '/normalInteractlogin?id=' + val.id+'&type=1&status=' + val.playStatus;
      // 		window.open(playUrl,'target');
      // 	}else{
      // 		playUrl = window.origin + '/normalInteractlogin?id=' + val.id+'&status=' + val.playStatus;
      // 		window.open(playUrl,'target');
      // 	}
      // }else {
      // 	playUrl = window.origin + '/interactlogin?id=' + val.id;
      // 	window.open(playUrl,'target');
      // }
    },
  },
