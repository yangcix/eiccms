const bmapcfg = {
  'tiles_dir'   : window.location.origin + '/img/map', // 瓦片地图的位置
  'customstyle' : '',	
  // 'tiles_dir'   : 'http://192.168.166.172/img/map',
  'home': window.location.origin + '/static/map' // 其他js文件的位置
};
...
window.TILE_VERSION = {
  ...
  window.BMapGL = window.BMapGL || {}; (function(bp, eB) {
    ...
    bp.getSeckey = function() {
      ...
      var e = bmapcfg.home + "/abclite-2063-s.js";
      ho.load(e)
    };
          ...
          if (e.hasOwnProperty(T)) {
            ...
            case "style":
                ...
                this.loadMapStyleFiles(function() {
                    hI.fire(new bc("onstyle_changed"))
                });
                break;
            case "styleUrl":
            ...
            if (!bp.iconSetInfoCustom) {
              ...
              ho.load(hY,function() {
                ...
                if (hV.indexOf("jsonp") > "-1") {
                  ...
                  bp.customStyleInfo.xhr = gB.get(hV, styleCbk)
                }
                console.log('99',bp)
              })
            } else {
    ...
    var f = {
      ...
      getStyleUrl: function(T, hU, hT, e) {
        ...
        i = bmapcfg.customstyle.length > 0 ? bmapcfg.customstyle : bmapcfg.home + "/customstyle/mapstyle";
        return i
      },
      ...
      calcIconAndTextInfo: function(h2) {
        if (this.objTextsPng && this.arrIconsPng) {
          ...
          hV = hW.length; hZ < hV; hZ++) {
            var hT = hW[hZ];
            var hX = this.arrIconsPng[hT.icon-png];
            var hU = hX.height / 2;
            var h1 = {
              type: "fixed",
              name: "",
          ...
          if (hV && hV.rtVertex) {
            if (!hW[i].formatedData) {
              T = {
                ...
                textureSource: hZ.textureSources && hW[i].processedInZoom ? hZ.textureSources[hW[i].processedInZoom] : "",
                textureHeight: hZ.textureHeights && hW[i].processedInZoom ? hZ.textureHeights[hW[i].processedInZoom] : "",
                renderData: {
                  vertex: hV.rtVertex,
              ...
              if (hY && hW[i].onDefaultFloor === false) {
                T.textureSource = hZ.indoorTextureSources && hW[i].processedInZoom ? hZ.indoorTextureSources[hW[i].processedInZoom] : "";
                T.textureHeight = hZ.indoorTextureHeights && hW[i].processedInZoom ? hZ.indoorTextureHeights[hW[i].processedInZoom] : ""
              }
              hW[i].formatedData = T
            } else {
              T = hW[i].formatedData;
