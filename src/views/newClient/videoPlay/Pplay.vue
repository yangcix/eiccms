	...
	<div class="pplayPage">
		<div class="video-content-wrap">
			<div class="video-wrap">
				...
				<el-dialog class="dialogPassword" :close-on-press-escape="false" :show-close="false"
					:visible.sync="dialogVisible" width="450px" :close-on-click-modal="false" :modal="false"
					style="position: absolute;" :z-index="1997">
...
import { judgeMobile, throttle } from "@/assets/js/utils";
export default {
	name: '',
	data() {
		this.toEvaluations = throttle(this.toEvaluation, 500);
		return {
			settimeVideo: null,
			recordInterval: null,
			passwordMsg: '',
	...
	methods: {
      ...
      if(query.etype){
		...
		setInit() {
			...
			this.playUrl = `${location.protocol}//${location.host}${playUrl}`; // host
